...
cell_types <- unique(microglia@meta.data$seurat_clusters)

scpa_out <- list()
bl_bm <- list(); bl_ln <- list()
for (i in cell_types) {
  cluster_0 <- seurat_extract(microglia, meta1 = "seurat_clusters", value_meta1 = 0)
  cluster_1 <- seurat_extract(microglia, meta1 = "seurat_clusters", value_meta1 = 1)
  cluster_2 <- seurat_extract(microglia, meta1 = "seurat_clusters", value_meta1 = 2)
...
saveRDS(scpa_out, file = "/home/adufour/work/rds_storage/microglia_scpa.rds")