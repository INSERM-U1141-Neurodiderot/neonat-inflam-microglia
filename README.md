...
This repository houses the codes for the single-cell transcriptome analyses presented in the study **Neonatal inflammation impairs developmentally associated subsets of microglia and promotes a highly reactive microglial subset** Brain Behav Immun. 2025 Jan;123:466-482.([https://doi-org.10.1016/j.bbi.2024.09.019](https://doi-org.10.1016/j.bbi.2024.09.019)). The raw and processed data are available on GEO with accession number [GSE165113](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE165113). The code used for data preprocessing is available on [https://github.com/Goultard59/indrops](https://github.com/Goultard59/indrops) and [https://github.com/Goultard59/indrops-targeted](https://github.com/Goultard59/indrops-targeted).
